...
<head>
    ...
    <title><?= APP_NAME ?> / Register - NiceAdmin Bootstrap Template</title>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?= BASEURL ?>/register/store" method="POST" class="row g-3 needs-validation">
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">Already have an account? <a href="<?= BASEURL ?>/login">Log in</a></p>
                                        </div>
                                    </form>
